...
date: 2022-03-29T00:11:00+08:00
draft: false
categories:
    - Linux 
---
...
![image.png](https://cdn.jsdelivr.net/gh/whuwangyong/whuwangyong.github.io/p/跨系统换行符导致脚本执行异常/assets/image-20220313173320-m3he0qa.png)

## vim状态栏的[noeol] [dos]是什么意思？

当config的line separator问`CRLF`时，vim打开Windows分区上的文件时，状态栏显示`[noeol][dos]`：

![image.png](https://cdn.jsdelivr.net/gh/whuwangyong/whuwangyong.github.io/p/跨系统换行符导致脚本执行异常/assets/image-20220313172145-gr1vmgk.png)

当config的line separator问`LF`时，vim打开Windows分区上的文件时，状态栏显示`[noeol]`：

![image.png](https://cdn.jsdelivr.net/gh/whuwangyong/whuwangyong.github.io/p/跨系统换行符导致脚本执行异常/assets/image-20220313172052-wah96f1.png)
